...
LSODIUMVER=0.6.1
DNSCRYPTVER=1.4.0
LSODIUMURL="http://download.libsodium.org/libsodium/releases/libsodium-$LSODIUMVER.tar.gz"
DNSCRYPTURL="http://download.dnscrypt.org/dnscrypt-proxy/dnscrypt-proxy-$DNSCRYPTVER.tar.gz"
